  ...
  return (
    <>
      ...
      <section className="bg-white"><div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-24">
        <AnimatedSection className="mx-auto max-w-3xl text-center"><h2 className="font-heading text-4xl font-extrabold text-navy sm:text-5xl">Trusted by Professionals</h2><p className="mt-6 leading-8 text-text-secondary">I-Care Services ICC works alongside GPs, social workers, NHS trusts, housing officers, schools, probation services, and voluntary sector organisations to provide specialist community support for their clients.</p></AnimatedSection>
