...
const accessOptions = [
  ...
  },
  {
    ...
    body: "Complete our simple self-referral form and we'll get back to you within 48 hours to arrange your first appointment.",
  ...
  },
  {
    ...
    body: `Prefer to write? Email us at ${CONTACT_INFO.email} and we'll respond within 24 hours.`,
      ...
      <section className="bg-cream">
        <AnimatedSection className="mx-auto max-w-3xl px-4 py-20 text-center sm:px-6 lg:py-24">
          ...
          <p className="mt-6 text-base leading-8 text-text-secondary sm:text-lg">
            ...
            you can&apos;t quite name yet, I-Care Services ICC is here. No
            judgment. No waiting lists. No referral needed.
          </p>
        ...
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-24">
          ...
          <AnimatedSection variant="staggerContainer" className="mt-12 grid gap-6 lg:grid-cols-3">
            {accessOptions.map(({ icon: Icon, title, body, label, href, button }) => (
              <motion.article key={title} variants={scaleIn} className="interactive-card flex flex-col rounded-[2rem] border border-cream-dark bg-cream/40 p-7">
      ...
      <section id="self-referral" className="scroll-mt-24 bg-cream-dark">
        <div className="mx-auto max-w-5xl px-4 py-20 sm:px-6 lg:px-8 lg:py-24">
          <AnimatedSection className="mb-10 text-center">
            ...
            <p className="mt-4 text-text-secondary">All information is kept strictly confidential</p>
          </AnimatedSection>
          <SelfReferralForm />
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          ...
          <AnimatedSection variant="staggerContainer" className="mt-12 grid gap-6 md:grid-cols-3">
            {[
              ...
              ["We'll Be In Touch", "Within 48 hours to discuss your needs"],
              ["Your Support Begins", "A tailored plan is created together"],
            ].map(([title, body], index) => (
              <motion.article key={title} variants={fadeInUp} className="rounded-3xl border border-white/10 bg-white/5 p-7 text-center">
