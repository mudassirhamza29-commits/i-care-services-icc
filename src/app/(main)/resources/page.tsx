...
export default function ResourcesPage() {
  return (
    <>
      <PageHero title="Resources" subtitle="Helpful guides, information, and signposting to support you" eyebrow="Clear information, practical next steps" visualVariant="resources" />
