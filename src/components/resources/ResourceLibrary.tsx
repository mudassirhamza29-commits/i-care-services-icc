...
const resources: Resource[] = [
  ...
  { title: "Finding Mental Health Support", type: "Information Sheet", category: "Mental Health", description: "Questions to ask when looking for regulated or community mental health support." },
